#include <com_intel_realsense_librealsense_Utils.h>
...
rs2_extrinsics extrinsic_jobject2rs(JNIEnv *env, jobject extrinsic) {
    ...
    return extrinsics;
     ...
     JNIEXPORT void JNICALL Java_com_intel_realsense_librealsense_Utils_nProjectPointToPixel(JNIEnv* env, jclass clazz, jobject pixel_2D, jobject intrinsic, jobject point_3D) {
...
JNIEXPORT void JNICALL Java_com_intel_realsense_librealsense_Utils_nDeprojectPixelToPoint(JNIEnv* env, jclass clazz, jobject point_3D, jobject intrinsic, jobject pixel_2D, jfloat depth) {
...
JNIEXPORT void JNICALL Java_com_intel_realsense_librealsense_Utils_nTransformPointToPoint(JNIEnv* env, jclass clazz, jobject to_point_3D, jobject extrinsic, jobject from_point_3D) {
...
JNIEXPORT void JNICALL Java_com_intel_realsense_librealsense_Utils_nGetFov(JNIEnv* env, jclass clazz, jobject fov, jobject intrinsic) {
